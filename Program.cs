using System;
using RhythmesGonnaGetYou;
using System.Linq;
using Microsoft.EntityFrameworkCore;

 namespace RhythmesGonnaGetYou
 {
     public class RhythmesGonnaGetYouContext : DbContext
    {
        ...
        {
            optionsBuilder.UseNpgsql("server=localhost;database=RhythmesGonnaGetYou");
    ...
    class Program
    {
        ...
        {
            var context = new RhythmesGonnaGetYouContext();
            Console.WriteLine();
            Console.WriteLine("Welcome To RhythmesGonnaGetYou");
